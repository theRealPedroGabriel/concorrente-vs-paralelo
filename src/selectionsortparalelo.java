...
public class selectionsortparalelo {
        ...
        for (int size : sizes) {
            for (String dataType : dataTypes) {
                ...
                for (int i = 0; i < 5; i++) {
                    ...
                    selectionSort(numThreads, array);
    ...
    public static void selectionSort(int numThreads,int[] array) {
        ForkJoinPool pool = new ForkJoinPool(numThreads);
        pool.invoke(new SelectionSortTask(array));
        pool.shutdown();
    }
    ...
    private static JFreeChart createChart(DefaultCategoryDataset dataset) {
        ...
        chart.setTitle(
                new TextTitle("Tempo de execusao do algoritimo selectionsort paralelo",
